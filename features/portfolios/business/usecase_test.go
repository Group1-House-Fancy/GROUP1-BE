...
func (mock mockPortfolioData) UpdatePortfolio(idPrtf int, data portfolios.Core) (int, error) {
	return 1, nil
}
...
func (mock mockPortfolioDataFailed) UpdatePortfolio(idPrtf int, data portfolios.Core) (int, error) {
...
func TestPutPortfolio(t *testing.T) {
	t.Run("Test Put Portfolio Success", func(t *testing.T) {
		...
		row, err := portfolioBusiness.PutPortfolio(1, data)
		assert.Nil(t, err)
		assert.Equal(t, 1, row)
	})
	...
	t.Run("Test Put Portfolio Failed When Client Name Empty", func(t *testing.T) {
		...
		row, err := portfolioBusiness.PutPortfolio(0, data)
		assert.NotNil(t, err)
		assert.Equal(t, -1, row)
	})
}
