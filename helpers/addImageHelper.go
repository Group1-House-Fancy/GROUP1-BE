...
func AddImageContractor(c echo.Context) (link string, message map[string]interface{}, err error) {
...
func AddImageCertificate(c echo.Context) (link string, message map[string]interface{}, err error) {
...
func AddHouseImage(c echo.Context) (link string, message map[string]interface{}, err error) {
	file, err := c.FormFile("files")
	bucket := os.Getenv("DB_BUCKET")
	if err != nil {
		url := "https://storage.googleapis.com/" + bucket + "/default_House_Image.png"
		return url, map[string]interface{}{
			"message": "Success create url",
			"code":    200,
		}, nil
...
func AddPortfolioImage(c echo.Context) (link string, message map[string]interface{}, err error) {
	file, err := c.FormFile("files")
	bucket := os.Getenv("DB_BUCKET")
	if err != nil {
		url := "https://storage.googleapis.com/" + bucket + "/default_House_Image.png"
